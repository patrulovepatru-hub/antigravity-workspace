...
**Status:** PoC Available (`exploits/FlashLoanGovernanceExploit.sol`)
...
**Status:** PoC Available (`exploits/TokenRecoveryTimingAttack.sol`)
...
**Status:** PoC Available (`exploits/SlashRewardManipulation.sol`)
...
|----------|-------|--------------|
| Crítica | 2 | **$50,000 - $100,000** |
| Alta | 2 | **$10,000 - $50,000** |
| Media | 4 | **$5,000 - $15,000** |
| Baja | 3 | $1,000 - $5,000 |
...
- [x] Develop PoC for H-01 (Reentrancy) - **DONE**
- [x] Verify M-02 (Flash loan) logic - **DONE**
- [ ] Complete BSCValidatorSet.sol analysis
- [x] Write Foundry exploit tests - **DONE**
